                        ...
                        <form role="search" method="post">
                          <div className="input-group">
                            ...
                            <span className="input-group-btn">
                              <button
                                type="submit"
                                className="btn btnhover primary"
                              >
                                Search
                              </button>
                            </span>
                            ...
                            <div className="dlab-post-header">
                              <h6 className="post-title">
                                <Link to={"blog-single-left-sidebar"}>
                                  This Is Why Restaurant Is So Famous
                                </Link>
                              </h6>
                            </div>
                          </div>
                        ...
                        <div className="widget-post clearfix">
                          ...
                          <div className="dlab-post-info">
                            ...
                            <div className="dlab-post-header">
                              <h6 className="post-title">
                                <Link to={"blog-single-left-sidebar"}>
                                  Learning Restaurant Is Not Difficult At All
                                </Link>
                              </h6>
                            </div>
                          </div>
                        ...
                        <div className="widget-post clearfix">
                          ...
                          <div className="dlab-post-info">
                            ...
                            <div className="dlab-post-header">
                              <h6 className="post-title">
                                <Link to={"blog-single-left-sidebar"}>
                                  Simple Guidance For You In Restaurant
                                </Link>
                              </h6>
                            </div>
                          </div>
                          ...
                          <ul id="lightgallery" className="lightgallery">
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic1.jpg")}
                                  className="check-km"
                                >
                                  <img
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic2.jpg")}
                                  className="check-km"
                                >
                                  <img
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic3.jpg")}
                                  className="check-km"
                                >
                                  <img
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic4.jpg")}
                                  className="check-km"
                                >
                                  <img
                                    src={require("../../images/gallery/pic4.jpg")}
                                    alt=""
                                  />
                                </a>
                              </div>
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic5.jpg")}
                                  className="check-km"
                                >
                                  <img
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic6.jpg")}
                                  className="check-km"
                                >
                                  <img
                                    src={require("../../images/gallery/pic6.jpg")}
                                    alt=""
                                  />
                                </a>
                              </div>
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic7.jpg")}
                                  className="check-km"
                                >
                                  <img
                            ...
                            <li>
                              <div className="dlab-post-thum dlab-img-effect">
                                <a
                                  href={require("../../images/gallery/pic8.jpg")}
                                  className="check-km"
                                >
                                  <img
