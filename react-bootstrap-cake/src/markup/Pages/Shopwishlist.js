                    ...
                    <table className="table check-tbl">
                      ...
                      <tbody>
                        ...
                        <tr className="alert">
                          <td className="product-item-img">
                            <img
                              src={require("../../images/product/thumb/item2.jpg")}
                              alt=""
                            />
                          </td>
                        ...
                        <tr className="alert">
                          <td className="product-item-img">
                            <img
                              src={require("../../images/product/thumb/item3.jpg")}
                              alt=""
                            />
                          </td>
                        ...
                        <tr className="alert">
                          <td className="product-item-img">
                            <img
                              src={require("../../images/product/thumb/item4.jpg")}
                              alt=""
                            />
                          </td>
                          <td className="product-item-name">Pizza</td>
                        ...
                        <tr className="alert">
                          <td className="product-item-img">
                            <img
                              src={require("../../images/product/thumb/item5.jpg")}
                              alt=""
                            />
                          </td>
                          <td className="product-item-name">Burger</td>
