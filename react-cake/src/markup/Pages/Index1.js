                  ...
                  <div className="col-lg-12">
                    <div className="section-head mb-0 text-center">
                      ...
                      <p className="main-text">
                        Join DexignZone <strong>Bakery</strong>™ to earn Gold
                        level benefits like free Cakes and food, get free
              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-lg-4 m-b30">
                    <img
                      src={require("../../images/about/pic1.jpg")}
                  ...
                  <div className="col-lg-6 m-b30">
                    <div className="m-r20">
                      <div className="section-head text-left">
                        ...
                        <p className="text-bold">
                          Where to buy our high quality Cake
                        </p>
                        <div className="dlab-separator style1 bg-primary"></div>
                      </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6">
                    <div className="port-box1 text-white">
                      <div className="dlab-media">
                        <img
                          src={require("../../images/our-work/pic2.jpg")}
                          alt=""
                        />
                      </div>
                      <div className="dlab-info">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6">
                    <div className="port-box1 text-white">
                      <div className="dlab-media">
                        <img
                          src={require("../../images/our-work/pic3.jpg")}
                          alt=""
                        />
                      </div>
                      <div className="dlab-info">
              ...
              <div className="container">
                <div className="row m-lr0 about-area1">
                  <div className="col-lg-6 p-lr0">
                    <img
                      className="img-cover"
                      src={require("../../images/about/pic3.jpg")}
                      alt=""
                    />
                  </div>
