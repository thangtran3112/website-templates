                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/burger/pic1.jpg")}
                          alt=""
                        />{" "}
                      </Link>
                    </div>
                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/burger/pic2.jpg")}
                          alt=""
                        />
                      </Link>
                    </div>
                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/burger/pic3.jpg")}
                          alt=""
                        />
                      </Link>
                    </div>
                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/burger/pic4.jpg")}
                          alt=""
                        />
                      </Link>
                    </div>
                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/burger/pic5.jpg")}
                          alt=""
                        />
                      </Link>
                    </div>
                ...
                <div className="dz-col col m-b30">
                  <div className="item-box shop-item style2">
                    <div className="item-img">
                      <Link>
                        <img
                          src={require("../../images/product/item1.jpg")}
                          alt=""
                        />
                      </Link>
                    </div>
